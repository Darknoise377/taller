...
export default function ChatWidget() {
  ...
  return (
    <>
      {/* ── Floating button ── */}
      <div className={`fixed ${isProductDetail ? 'bottom-[calc(8.5rem+env(safe-area-inset-bottom))]' : 'bottom-20'} md:bottom-6 left-4 z-40 flex flex-col items-start gap-2`}>
        {/* Tooltip bubble */}
        <AnimatePresence>
          {showLabel && !open && (
            <motion.div
          ...
          >
            ...
            <div className="flex items-center gap-3 px-4 py-3 bg-[#0A2A66] text-white flex-shrink-0">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold leading-tight">Mecha · Asesor A&R</p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="bg-slate-100 dark:bg-slate-800 rounded-2xl rounded-tl-sm px-3 py-2 text-sm text-slate-700 dark:text-slate-200 max-w-[85%]">
                      ¡Hola! Soy <strong>Mecha</strong>, el asesor de <strong>Motoservicio A&R</strong>. Cuéntame qué necesitas para tu moto y te ayudo a encontrarlo. 🏍️
                    </div>
                  </div>
